...
public class ORGate : ElectricalComponent
{
    public static TilemapClick tilemapClick;
    private bool lastPoweredState = false;
    private Tutorial_1Click tilemapClickInstance;
    public ORGate(Tilemap tilemap, Vector3Int position, TilemapClick tilemapClickInstance) : base(tilemap, position)
    {
        ...
        tilemap.SetTile(position + Vector3Int.down, tilemapClick.ORGate2);
        tilemap.SetTile(position + 2*Vector3Int.down, tilemapClick.ORGate3);
    }

    public ORGate(Tilemap tilemap, Vector3Int position, Tutorial_1Click tilemapClickInstance) : base(tilemap, position)
    {
