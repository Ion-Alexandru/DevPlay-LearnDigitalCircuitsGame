...
public class ANDGate : ElectricalComponent
{
    ...
    public ANDGate(Tilemap tilemap, Vector3Int position, TilemapClick tilemapClickInstance) : base(tilemap, position)
    {
        ...
        tilemap.SetTile(position + Vector3Int.down, tilemapClick.ANDGate2);
        tilemap.SetTile(position + 2*Vector3Int.down, tilemapClick.ANDGate3);
    }

    public ANDGate(Tilemap tilemap, Vector3Int position, Tutorial_1Click tilemapClickInstance) : base(tilemap, position)
    {
    ...
    public override void UpdateState(Dictionary<Vector3Int, ElectricalComponent> components)
    {
        ...
        isPowered = input1Powered && input2Powered;
